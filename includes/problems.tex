...
\label{sec:problems}
    ...
    The suite is divided into two categories. The first category, labeled Amazon, started as two seed files.
    ...
    \todo{Can I say that these problems were deemed industrially relevant by Amazon? Probably not, right?} 
    In total, 516 unique problems were generated from these two seeds.
    
    The second category, Regex, is seeded by the z3str2 regular expression test suite \cite{} \todo{Is this right? If so where we can cite?}. This test suite contains 42 problems dealing with a wide variety of regular expressions.
