\section{\fuzzer{}}
    ...
    \begin{description}
        ...
        \item[\texttt{stringfuzzx}] \hfill \\
            ...
            This tool transforms \smt{} problems.. It supports several transformers and options that specify its output and input. \todo{Maybe describe SAT-preserving properties?} The transformers it implements are: \\
